...
# and send them as USB HID keyboard and mouse events to host.
#
serial = usb_cdc.data
...
button_map = (
    ...
    Keycode.RIGHT_SHIFT, Keycode.RETURN, Keycode.SPACE, Keycode.SHIFT, # left/right shoulder, blank, blank
    Keycode.SPACE, Keycode.E, Keycode.SPACE, # select, start, blank
    Keycode.SPACE, Keycode.SPACE, # left/right stick buttons
